...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "tripaanshi@gmail.com",
    href: "mailto:tripaanshi@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/tripaanshi/",
    content: "/tripaanshi",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Anshika Tripathi, a Computer Science Engineer passionate about building innovative and scalable software solutions.  
I have hands-on experience through internships and projects in full-stack development, Generative AI, and SaaS applications, where I’ve built AI-powered platforms, financial applications, and interactive web solutions.  

I enjoy solving complex problems (400+ DSA problems across LeetCode & GFG) and love working with technologies like Next.js, React, Node.js, and Hugging Face. My focus is on creating impactful applications that combine strong engineering principles with intuitive design.  

Always curious and eager to learn, collaborate, and take on challenges that push the boundaries of technology 🚀
            </p>
            <p className="mb-10">
