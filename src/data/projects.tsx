...
const projects: Project[] = [
    ...
    get content() {
      return (
        <div>
          ...
          <p className="font-mono mb-2">
            My top personal project — no filler, all killer.
          </p>
          <SlideShow
            images={[
  ...
  { // 02. Real-time Chat Project
  id: "real-time-chat",
  category: "Communication",
  title: "Real-time Chat App",
  src: "/assets/projects-screenshots/chat-app/11.png",
  screenshots: ["11.png", "12.png", "13.png"],
  live: "https://mern-chat-app-o6yp.onrender.com/",
  github: "https://github.com/softyanshi/mern-chat-app",
  skills: {
    frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.next,PROJECT_SKILLS.react,PROJECT_SKILLS.ts, // in case zustand not defined
       PROJECT_SKILLS.tailwind],
  ...
  get content() {
    return (
      <div>
        <TypographyP className="font-mono">
          Real-time Chat App allows users to communicate instantly with private or group messages. Features include typing indicators, message read receipts, and a clean responsive interface for mobile and desktop users.
        </TypographyP>
        <ProjectsLinks live={this.live} repo={this.github} />
        <SlideShow
          images={[
            `${BASE_PATH}/chat-app/11.png`,
            `${BASE_PATH}/chat-app/12.png`,
            `${BASE_PATH}/chat-app/13.png`,
        ...
        <ul className="list-disc ml-6 font-mono">
          ...
          <li>Error handling on both client & server</li>
        </ul>
      </div>
    );
  },
...
{ // . AI SaaS Project
  id: "ai-saas",
  category: "AI SaaS",
  title: "AI SaaS LMS Platform",
  src: "/assets/projects-screenshots/saas-lms/11.png",
  screenshots: ["1.png", "2.png", "3.png"],
  live: "https://saas-app-two-beryl.vercel.app/",
  github: "https://github.com/softyanshi/saas-app",
  skills: {
    frontend: [PROJECT_SKILLS.js,PROJECT_SKILLS.ts, PROJECT_SKILLS.next,PROJECT_SKILLS.shadcn, PROJECT_SKILLS.tailwind, PROJECT_SKILLS.vite],
    backend: [ PROJECT_SKILLS.supabase, PROJECT_SKILLS.next],
  },
  get content() {
    return (
      <div>
        <TypographyP className="font-mono">
          AI SaaS Dashboard helps users generate, analyze, and manage AI-driven content and workflows in a seamless web interface. Users can interact with AI models, track analytics, and integrate third-party services all in one place.
        </TypographyP>
        <ProjectsLinks live={this.live} repo={this.github} />
        <SlideShow
          images={[
            `${BASE_PATH}/saas-lms/11.png`,
            `${BASE_PATH}/saas-lms/12.png`,
            `${BASE_PATH}/saas-lms/13.png`,
          ]}
        />
        <TypographyH3 className="my-4 mt-8">Features</TypographyH3>
        <ul className="list-disc ml-6 font-mono">
          <li>Sign up and authenticate using Clerk</li>
            <li>Subscribe to plans via Stripe</li>
            <li>Interact with AI-powered voice tutors using Vapi</li>
            <li>Manage sessions and bookmarks</li>
            <li>Create custom AI tutors</li>
        </ul>
      </div>
    );
  },
  ...
  { // Fintech Banking Project
    ...
    src: "/assets/projects-screenshots/fintech-bank/1.png",
    screenshots: ["assets/projects-screenshots/fintech-bank/1.png", "2.png", "3.png" ,"4.png","5.png","6.png","7.png","8.png","9.png","10.png"],
    live: "https://banking-two-beta.vercel.app/",
    github:"https://github.com/softyanshi/banking",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
    ...
    get content() {
      return (
        ...
        <SlideShow
          images={[
            `${BASE_PATH}/fintech-bank/1.png`,
            `${BASE_PATH}/fintech-bank/2.png`,
            `${BASE_PATH}/fintech-bank/3.png`,
            `${BASE_PATH}/fintech-bank/4.png`,
            `${BASE_PATH}/fintech-bank/5.png`,
            `${BASE_PATH}/fintech-bank/6.png`,
            `${BASE_PATH}/fintech-bank/7.png`
          ]}
        />
          
          <ul className="font-mono list-disc ml-6">
          <li>Secure Authentication & Authorization with SSR validations</li>
          <li>Connect multiple bank accounts via Plaid integration</li>
          <li>Real-time account overview & transaction updates</li>
  ...
  { // 05. MERN Stack Portal
    id: "mern-job-portal",
    category: "Web Development",
    title: "MERN Job Portal",
    src: "/assets/projects-screenshots/job-portal/1.png",
    screenshots: ["1.png","2.png" ,"3.png" , "4.png", "5.png","6.png" , "7.png"],
    live: "https://job-portal-custom-frontend.onrender.com/",
    github:"https://github.com/softyanshi/job-portal-custom",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            A full-stack MERN job portal with role-based dashboards for Students and Recruiters. The platform features a responsive UI, dark/light mode toggle, secure authentication, advanced job search and filters, and complete profile management.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/job-portal/1.png`,
              `${BASE_PATH}/job-portal/2.png`,
              `${BASE_PATH}/job-portal/3.png`,
              `${BASE_PATH}/job-portal/4.png`,
              `${BASE_PATH}/job-portal/5.png`,
              `${BASE_PATH}/job-portal/6.png`,
              `${BASE_PATH}/job-portal/7.png`,
            ]}
          />
        </div>
      );
